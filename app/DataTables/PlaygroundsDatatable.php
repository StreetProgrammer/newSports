...
class PlaygroundsDatatable extends DataTable
{
    ...
    public function dataTable($query)
    {
        return datatables($query)
            ->addColumn('checkbox', 'admin.Playgrounds.btns.checkbox')
            ->addColumn('view', 'admin.Playgrounds.btns.view')
            ->addColumn('delete', 'admin.Playgrounds.btns.delete')
            ->rawColumns([
                'checkbox',
                'view',
                'delete'
    ...
    {
        return 'Playgrounds_' . date('YmdHis');
    }
}
