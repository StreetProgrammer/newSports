...
<!------ start Profile Content---------->
    ...
    <section class="content-header">
      <h1>
        {{ trans('admin.single_playground.Playground_Data') }}
        <span class="text-muted" style="font-size: 11px;">
            {{ trans('admin.single_playground.Created_since') }}  {{ date('d-m-Y', strtotime($Playground->created_at)) }}
            </span>
      </h1>
      
      <ol class="breadcrumb">
        <li><a href="{{ aurl('/') }}"><i class="fa fa-dashboard"></i> {{ trans('admin.single_playground.dashboard') }}</a></li>
        <li><a href="{{ aurl('/') }}/playgrounds">{{ trans('admin.single_playground.playgrounds') }}</a></li>
              ...
              <ul class="list-group list-group-unbordered displayDetails">
                  <li class="list-group-item">
                      ...
                      <span class="btn btn-danger btn-flat btn-xs">
                        <a class="pull-right" href="{{ aurl('/') }}/{{ $Playground->branch->id }}" style="color: #fff;">
                  ...
                  <li class="list-group-item">
                      ...
                      <span class="btn btn-danger btn-flat btn-xs">
                        <a class="pull-right" href="{{ aurl('/') }}/{{ $Playground->clubUser->id }}" style="color: #fff;">
