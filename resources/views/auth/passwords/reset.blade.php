          ...
          {!! csrf_field() !!}
            ...
            <div class="wrap-input100 validate-input m-b-16 @if ($errors->has('password')) alert-validate @endif" 
                    data-validate = "{{------------------------}}
                                    ...
                                    {{------------------------}}"
            >
                <input type="password" name="password" value="{{ old('password') }}" placeholder="{{ trans('player.Password') }}" class="input100">
                <span class="focus-input100"></span>
                <span class="symbol-input100">
            ...
            <div class="wrap-input100 validate-input m-b-16 @if ($errors->has('password_confirmation')) alert-validate @endif" 
                    data-validate = "{{------------------------}}
                                    @if ($errors->has('email'))
                                        {{ $errors->first('email') }}
                                    @else
                                    ...
                                    {{------------------------}}"
            >
                <input type="password" name="password_confirmation" value="{{ old('password-confirm') }}" placeholder="{{ trans('player.PasswordConfirmation') }}" class="input100">
                <span class="focus-input100"></span>
                <span class="symbol-input100">
                <span class="lnr lnr-lock"></span>
                </span>
